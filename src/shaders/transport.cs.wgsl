...
fn read_uX(ix: i32, iy: i32) -> f32 {
  ...
  return textureLoad(uXtex, vec2<i32>(cx, cy), 0).x;
}
...
fn read_uY(ix: i32, iy: i32) -> f32 {
  ...
  let cx = clampI(ix, 0, w-1);
  let cy = clampI(iy, 0, h-1);
  return textureLoad(uYtex, vec2<i32>(cx, cy), 0).x;
}
...
fn bicubicSampleLambda(coord: vec2<f32>) -> f32 {
  ...
  let s00 = textureLoad(lambdaIn, vec2<i32>(xm1, ym1), 0).x;
  let s10 = textureLoad(lambdaIn, vec2<i32>(x0 , ym1), 0).x;
  let s20 = textureLoad(lambdaIn, vec2<i32>(xp1, ym1), 0).x;
  let s30 = textureLoad(lambdaIn, vec2<i32>(xp2, ym1), 0).x;

  let s01 = textureLoad(lambdaIn, vec2<i32>(xm1, y0 ), 0).x;
  let s11 = textureLoad(lambdaIn, vec2<i32>(x0 , y0 ), 0).x;
  let s21 = textureLoad(lambdaIn, vec2<i32>(xp1, y0 ), 0).x;
  let s31 = textureLoad(lambdaIn, vec2<i32>(xp2, y0 ), 0).x;

  let s02 = textureLoad(lambdaIn, vec2<i32>(xm1, yp1), 0).x;
  let s12 = textureLoad(lambdaIn, vec2<i32>(x0 , yp1), 0).x;
  let s22 = textureLoad(lambdaIn, vec2<i32>(xp1, yp1), 0).x;
  let s32 = textureLoad(lambdaIn, vec2<i32>(xp2, yp1), 0).x;

  let s03 = textureLoad(lambdaIn, vec2<i32>(xm1, yp2), 0).x;
  let s13 = textureLoad(lambdaIn, vec2<i32>(x0 , yp2), 0).x;
  let s23 = textureLoad(lambdaIn, vec2<i32>(xp1, yp2), 0).x;
  let s33 = textureLoad(lambdaIn, vec2<i32>(xp2, yp2), 0).x;
